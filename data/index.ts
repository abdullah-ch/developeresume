	...
	experience: [
		{
			...
			tasks: [
				...
				`Architected microservices using NestJS, Kafka, Kubernetes and Docker, enabling scalable and fault-tolerant communication between financial services, reducing system downtime and improving performance by <strong>35%</strong>.`
			]
		},
		{
			id: uuidv4(),
